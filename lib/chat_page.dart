          ...
          child: Container(
            ...
            child: CircleAvatar(
              ...
              child: SafeNetworkImage(
                ...
                borderRadius: BorderRadius.circular(28),
                fit: BoxFit.cover,
                fallbackWidget: (avatarUrl == null || avatarUrl.isEmpty)
                  ? Center(child: Text(firstName.isNotEmpty ? firstName[0] : "?", style: GoogleFonts.outfit(color: kTextTitle, fontWeight: FontWeight.bold)))
                  : null,
                fallbackColor: kCardColor,
              ),
            ),
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      child: SafeNetworkImage(
                        ...
                        fit: BoxFit.cover,
                        fallbackWidget: (avatarUrl == null || avatarUrl.isEmpty)
                          ? Center(child: Text(name.isNotEmpty ? name[0] : "?", style: GoogleFonts.outfit(color: kTextTitle, fontWeight: FontWeight.bold, fontSize: 20)))
                          : null,
