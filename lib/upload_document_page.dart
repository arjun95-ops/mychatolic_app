          ...
          child: Container(
            ...
            child: file == null
                ? Column(
                    ...
                    children: [
                      Icon(Icons.add_a_photo_rounded, color: accentOrange.withOpacity(0.8), size: 40),
                      const SizedBox(height: 8),
                      Text("Ketuk untuk Upload", style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 12)),
                    ],
                  )
                : Container(
                    decoration: BoxDecoration(
