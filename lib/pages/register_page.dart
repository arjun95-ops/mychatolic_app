...
class _RegisterPageState extends State<RegisterPage> {
  ...
  String? _selectedParishId; // Optional if you need it locally, but we wont save it to profiles based on mismatch rules
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        ...
                        style: GoogleFonts.outfit(color: metaColor, fontWeight: FontWeight.bold),
                      ),
                    ],
                  ),
                ),
                        ...
                        SizedBox(
                            ...
                            child: Ink(
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  ...
                                  style: GoogleFonts.outfit(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16, letterSpacing: 1.5),
                                ),
                              ),
                            ),
                          ),
                         ...
                         if (_currentStep == 1) ...[
                            ...
                            Row(
                                ...
                                children: [
                                  Text("Sudah punya akun? ", style: GoogleFonts.outfit(color: bodyColor)),
                                  GestureDetector(
                                    onTap: () => Navigator.pop(context),
                                    child: Text("MASUK", style: GoogleFonts.outfit(color: primaryColor, fontWeight: FontWeight.bold)),
                                  )
                                ],
                              )
                         ]
  ...
  String _getStepTitle() {
    switch (_currentStep) {
      case 1: return "Buat Akun";
      case 2: return "Data Diri";
      case 3: return "Lokasi";
      case 4: return "Peran & Iman";
      default: return "";
    }
  }
  ...
  String _getStepSubtitle() {
    switch (_currentStep) {
      case 1: return "Masukkan kredensial akun anda.";
      case 2: return "Beritahu kami tentang diri anda.";
      case 3: return "Dimana anda bergereja?";
      case 4: return "Pilih peran pelayanan anda.";
      default: return "";
    }
  }
  ...
  Widget _buildStep1(ThemeData theme) {
    return Column(
      children: [
        _buildTextField("Email", "Masukkan email", _emailController, Icons.email_outlined, theme, keyboardType: TextInputType.emailAddress),
        const SizedBox(height: 20),
        _buildTextField("No. Handphone", "08xxxxxxxxxx", _phoneController, Icons.phone_android_rounded, theme, keyboardType: TextInputType.phone),
        const SizedBox(height: 20),
        _buildTextField("Password", "Buat password", _passwordController, Icons.lock_outline, theme, isObscure: true, toggleObscure: () => setState(() => _obscurePassword = !_obscurePassword), isPasswordVisible: !_obscurePassword),
        const SizedBox(height: 20),
        _buildTextField("Konfirmasi Password", "Ulangi password", _confirmPasswordController, Icons.lock_outline, theme, isObscure: true, toggleObscure: () => setState(() => _obscureConfirm = !_obscureConfirm), isPasswordVisible: !_obscureConfirm),
      ],
    );
  }
  ...
  Widget _buildStep2(ThemeData theme) {
    return Column(
      children: [
        _buildTextField("Nama Lengkap", "Sesuai KTP", _nameController, Icons.person_outline, theme),
        const SizedBox(height: 20),
        GestureDetector(
          onTap: _selectDate,
          child: AbsorbPointer(
             child: _buildTextField("Tanggal Lahir", "DD/MM/YYYY", _dobController, Icons.calendar_today, theme),
          ),
        ),
        const SizedBox(height: 20),
        _buildTextField("Suku", "Contoh: Batak, Jawa", _sukuController, Icons.people_outline, theme),
      ],
    );
  }
  ...
  Widget _buildStep3(ThemeData theme) {
    return Column(
      children: [
         // NEGARA
        _buildDropdownField("Negara", "Pilih Negara", _countryController, theme, onTap: () {
        ...
        // KEUSKUPAN
        _buildDropdownField("Keuskupan", "Pilih Keuskupan", _dioceseController, theme, onTap: () {
          if (_selectedCountryId == null) {
        ...
        // PAROKI
        _buildDropdownField("Paroki", "Pilih Paroki", _parishController, theme, onTap: () {
  ...
  Widget _buildStep4(ThemeData theme) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text("PILIH PERAN", style: GoogleFonts.outfit(color: metaColor, fontSize: 12, fontWeight: FontWeight.bold)),
        ...
        Container(
           ...
           child: Row(
             children: [
               Checkbox(
                 value: _isCatechumen,
                 onChanged: (val) => setState(() => _isCatechumen = val ?? false),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: isSelected ? [BoxShadow(color: primaryColor.withValues(alpha: 0.4), blurRadius: 8)] : [],
        ),
        child: Text(
          role,
          style: GoogleFonts.outfit(
  ...
  Widget _buildTextField(
    String label, String hint, TextEditingController controller, IconData icon, ThemeData theme,
    {bool isObscure = false, VoidCallback? toggleObscure, bool? isPasswordVisible, TextInputType keyboardType = TextInputType.text}
  ) {
    final metaColor = theme.textTheme.bodySmall?.color ?? Colors.grey;
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(label.toUpperCase(), style: GoogleFonts.outfit(color: metaColor, fontSize: 12, fontWeight: FontWeight.bold)),
        const SizedBox(height: 8),
        TextField(
          controller: controller,
          obscureText: isObscure && (isPasswordVisible == false || isPasswordVisible == null),
          keyboardType: keyboardType,
          style: GoogleFonts.outfit(color: theme.textTheme.bodyLarge?.color, fontWeight: FontWeight.w600),
          decoration: InputDecoration(
            ...
            hintText: hint,
            hintStyle: GoogleFonts.outfit(color: metaColor.withValues(alpha: 0.5)),
  ...
  Widget _buildDropdownField(String label, String hint, TextEditingController controller, ThemeData theme, {VoidCallback? onTap}) {
    final metaColor = theme.textTheme.bodySmall?.color ?? Colors.grey;
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
              ...
              children: [
                Expanded(
                  child: Text(
                    ...
                    style: GoogleFonts.outfit(
                      color: controller.text.isEmpty ? metaColor.withValues(alpha: 0.5) : theme.textTheme.bodyLarge?.color,
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("Pilih $title", style: GoogleFonts.outfit(color: theme.textTheme.bodyLarge?.color, fontSize: 20, fontWeight: FontWeight.bold)),
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      fillColor: theme.cardColor,
                      hintText: "Cari $title...",
                      hintStyle: GoogleFonts.outfit(color: theme.textTheme.bodySmall?.color),
                    ...
                    child: FutureBuilder<List<Map<String, dynamic>>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (!snapshot.hasData || snapshot.data!.isEmpty) {
                          return Center(child: Text("Data tidak ditemukan", style: GoogleFonts.outfit(color: theme.textTheme.bodySmall?.color)));
                        }
                        ...
                        return ListView.separated(
                          ...
                          itemBuilder: (ctx, index) {
                            ...
                            return ListTile(
                              title: Text(item[columnName] ?? 'Unknown', style: GoogleFonts.outfit(color: theme.textTheme.bodyLarge?.color)),
                              onTap: () {
                                // Pass ID as String (UUID)
                                onSelected(item['id'].toString(), item[columnName]);
                                Navigator.pop(ctx);
                              },
                            );
                          },
