...
class _VerificationPageState extends State<VerificationPage> {
  ...
  static const String DOC_KTP = 'KTP / Identitas';
  static const String DOC_BAPTIS = 'Surat Baptis';
  static const String DOC_KRISMA = 'Surat Krisma';
  static const String DOC_TUGAS = 'Surat Tugas Resmi';
  ...
  Future<void> _submitVerification() async {
    ...
    try {
      ...
      if (_documents[DOC_KTP] != null) updates['ktp_url'] = _documents[DOC_KTP];
      if (_documents[DOC_BAPTIS] != null) updates['baptism_cert_url'] = _documents[DOC_BAPTIS];
      if (_documents[DOC_KRISMA] != null) updates['chrism_cert_url'] = _documents[DOC_KRISMA];
      if (_documents[DOC_TUGAS] != null) updates['assignment_letter_url'] = _documents[DOC_TUGAS];
