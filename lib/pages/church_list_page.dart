...
class _ChurchListPageState extends State<ChurchListPage> {
  ...
  // --- STRICT LIGHT THEME CONSTANTS ---
  static const Color kPrimaryBrand = Color(0xFF0088CC);
  static const Color kBackgroundMain = Color(0xFFFFFFFF);
  static const Color kBackgroundSurface = Color(0xFFF5F5F5);
  ...
  void _showSupabaseSelectionModal({
    ...
    required Function(String id, String name) onSelected, // Changed ID to String
    String? filterColumn,
    dynamic filterValue,
  }) {
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("Pilih $title", style: GoogleFonts.outfit(color: kTextPrimary, fontSize: 20, fontWeight: FontWeight.bold)),
                    ...
                    child: FutureBuilder<List<Map<String, dynamic>>>(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState == ConnectionState.waiting) {
                          return const Center(child: CircularProgressIndicator(color: kPrimaryBrand));
                        }
                        ...
                        if (data == null || data.isEmpty) {
                          return Center(child: Text("Data tidak ditemukan", style: GoogleFonts.outfit(color: kTextSecondary)));
                        }
                        ...
                        return ListView.separated(
                          ...
                          itemBuilder: (ctx, index) {
                            ...
                            return ListTile(
                              title: Text(name, style: GoogleFonts.outfit(color: kTextPrimary)),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: kBackgroundMain, // Strict White
      appBar: const MyCatholicAppBar(
        title: "Cari Paroki & Stasi",
      ),
        ...
        slivers: [
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      filled: true,
                      fillColor: kBackgroundSurface, 
                      prefixIcon: const Icon(Icons.search, color: kPrimaryBrand),
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        _buildFilterButton(_countryName ?? "Semua Negara", _openCountryFilter, isActive: _selectedCountryId != null),
                        const SizedBox(width: 8),
                         const Icon(Icons.arrow_right_rounded, color: Colors.grey),
                        const SizedBox(width: 8),
                        _buildFilterButton(_dioceseName ?? "Semua Keuskupan", _openDioceseFilter, isActive: _selectedDioceseId != null),
                      ],
                    ),
                  )
                ],
          ...
          StreamBuilder<List<Map<String, dynamic>>>(
            ...
            builder: (context, snapshot) {
              ...
              // LOADING STATE
              if (snapshot.connectionState == ConnectionState.waiting) {
                return const SliverFillRemaining(child: Center(child: CircularProgressIndicator(color: kPrimaryBrand)));
              }
                ...
                return SliverFillRemaining(
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        const Icon(Icons.church_outlined, size: 48, color: Colors.black26),
                        const SizedBox(height: 16),
                        Text("Tidak ada gereja ditemukan", style: GoogleFonts.outfit(color: kTextSecondary)),
                      ],
                    ),
                  ),
                );
                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 16),
                        Text("Pencarian tidak ditemukan", style: GoogleFonts.outfit(color: kTextSecondary)),
                      ],
                    ),
                  ),
                );
  ...
  Widget _buildFilterButton(String label, VoidCallback onTap, {required bool isActive}) {
    return GestureDetector(
      onTap: onTap,
      child: Container(
        padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 10),
        decoration: BoxDecoration(
          color: isActive ? kPrimaryBrand.withOpacity(0.1) : kBackgroundSurface,
          borderRadius: BorderRadius.circular(20),
          border: Border.all(color: isActive ? kPrimaryBrand : Colors.transparent),
        ),
        child: Row(
          children: [
            Text(
              ...
              style: GoogleFonts.outfit(
                color: isActive ? kPrimaryBrand : kTextPrimary,
                fontWeight: FontWeight.bold,
                fontSize: 13
              ),
            ),
            const SizedBox(width: 4),
            Icon(Icons.keyboard_arrow_down_rounded, color: isActive ? kPrimaryBrand : kTextSecondary, size: 16)
          ],
        ),
      ),
    );
  ...
  Widget _buildChurchCard(Map<String, dynamic> data) {
    return Card(
      elevation: 0, 
      color: kBackgroundSurface, 
      margin: EdgeInsets.zero,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
      child: InkWell(
        onTap: () {
          Navigator.push(context, MaterialPageRoute(builder: (_) => ChurchDetailPage(churchData: data)));
        },
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: GoogleFonts.outfit(color: kTextSecondary, fontSize: 13),
