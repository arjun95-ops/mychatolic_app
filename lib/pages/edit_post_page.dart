...
class _EditPostPageState extends State<EditPostPage> {
  ...
  void initState() {
    super.initState();
    _captionController = TextEditingController(text: widget.post.caption ?? widget.post.content ?? "");
  }
            ...
            if (widget.post.imageUrl != null && widget.post.imageUrl!.isNotEmpty) ...[
               Container(
                 ...
                 child: ClipRRect(
                    ...
                    child: SafeNetworkImage(imageUrl: widget.post.imageUrl, fit: BoxFit.cover,),
                 ),
               ),
