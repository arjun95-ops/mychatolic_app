...
class _VerificationUploadPageState extends State<VerificationUploadPage> {
  ...
  Future<void> _pickImage(int type, ImageSource source) async {
    ...
    if (pickedFile != null) {
      setState(() {
        if (type == 1) _baptismImage = File(pickedFile.path); 
        else if (type == 2) _ktpImage = File(pickedFile.path);
        else if (type == 3) _faceImage = File(pickedFile.path);
        else if (type == 4) _confirmationImage = File(pickedFile.path);
      });
    }
  }
          ...
          children: [
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(color: accentIndigo.withOpacity(0.1), shape: BoxShape.circle),
            ...
            Container(
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(16),
                boxShadow: [BoxShadow(color: accentIndigo.withOpacity(0.3), blurRadius: 10, offset: const Offset(0, 4))]
              ),
